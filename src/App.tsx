...
type AppPage = 'landing' | 'audit' | 'results' | 'history';
      ...
      <header className="header">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: '0 0 0 10px', alignSelf: 'flex-end', paddingBottom: '4px', display: 'none' }} className="mobile-hide">CEC Document Auditor</p>
          </div>
