...
export const RefundPolicyPage: FC = () => (
  <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
    ...
    <div style={{ lineHeight: 1.8, fontSize: '0.95rem', color: '#374151' }}>
      ...
      <p>We stand behind the quality of Mentor Visa's tools. Our plans (Optimize and Execute) are <strong>one-time purchases</strong> — not subscriptions. If you purchase a plan and are not satisfied with the value provided, you are eligible for a full refund within <strong>3 days (72 hours)</strong> of your original purchase.</p>
      ...
      <p>Once the 3-day guarantee period has passed, all sales are considered <strong>final and non-refundable</strong>. Because our plans are one-time purchases that unlock instant digital access, we do not offer partial or prorated refunds for unused features.</p>
      ...
      <p>If you believe your situation qualifies for an exception under Section 2 (such as duplicate billing), please contact us within <strong>30 days</strong> of the original transaction.</p>
