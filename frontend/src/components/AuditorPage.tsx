    ...
    <div>
      ...
      <section className="page-hero">
        <div className="page-hero-content">
          ...
          <h1>One Missing Sentence =<br /><span className="hero-highlight" style={{ color: 'var(--primary-light)' }}>PR Refusal.</span></h1>
          ...
          <p style={{ maxWidth: '700px', margin: '0 auto 24px auto', fontSize: '1.1rem', lineHeight: '1.6' }}>
            IRCC rejects thousands of applications yearly because of a single missing sentence or formatting error on the employment reference letter. Drop your document below to instantly audit it against all 9 mandatory IRCC requirements.
          </p>
          
          {!result && !loading && (
             <>
                <a href="#audit-input" className="btn btn-primary btn-lg" style={{ textDecoration: 'none', display: 'inline-block', marginBottom: '12px' }}>
                  Audit My Letter Now
                </a>
